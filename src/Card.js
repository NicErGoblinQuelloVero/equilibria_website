    ...
    return(
        <div>
             <div className="card mx-auto animated-card cardHome" style={{ borderRadius: "25px", border: "none", boxShadow: "0px 10px 15px rgba(0, 0, 0, 0.1)" }}>
                        ...
                        <a className="btn btn-primary btn-lg px-5 py-3 fw-bolder bottoneCard inc " href="https://github.com/EquilibriaCC/Equilibria/wiki"><p className="cText">Learn more</p></a>
                        </div>
                    </div>
        </div>
    );
